...
import i1 from '../../assets/Ceremonies/1.JPG';
import i2 from '../../assets/Ceremonies/2.JPG';
import i3 from '../../assets/Ceremonies/3.JPG';
import i4 from '../../assets/Ceremonies/4.JPG';
import i5 from '../../assets/Ceremonies/5.JPG';
import i6 from '../../assets/Ceremonies/6.JPG';
import i7 from '../../assets/Ceremonies/7.JPG';


function CeremonyImg() {
        ...
        <>
            <div className='bg-[#EDF0F2] lg:px-20'>
                <div className='md:pt-32 lg:pt-44 px-6 py-20'>
                    <h5 className='text-[#07294D] text-[18px] font-bold font-montserrat'>Welcome to our</h5>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 2xl:grid-cols-4 gap-6 lg:gap-8 ">
                        {CampusImages.map((campus, index) => (
                                ...
                                <img 
                                    src={campus.image} 
                                    alt={campus.name} 
                                    className="w-full h-60 md:h-72 lg:h-64  rounded-xl object-fill"
                                />
